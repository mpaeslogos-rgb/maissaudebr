...
exports.parseDigitableLine = parseDigitableLine;
exports.validateBoleto = validateBoleto;
exports.formatDigitableLine = formatDigitableLine;
...
function digitableToBarcode(line) {
    if (line.length !== 47)
        return null;
    ...
    const barcode = campo1.substring(0, 4) +
        dvGeral +
        campo5 +
...
function validateBarcodeDV(barcode) {
...
function validateBoleto(digitableLine) {
